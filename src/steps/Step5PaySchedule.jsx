              ...
              <div className="grid grid-cols-5 gap-2 md:gap-3">
                {WEEKDAYS.map((d) => (
                  <button
                    ...
                    className={`px-3 py-3 md:py-4 rounded-xl border text-sm md:text-base font-medium transition-colors ${
              ...
              <div className="grid grid-cols-5 md:grid-cols-6 gap-2 md:gap-3">
                {dayTiles.map((d) => (
                  <button
                    ...
                    className={`rounded-lg border py-3 md:py-4 text-sm md:text-base font-medium transition-colors ${
                ...
                <button
                  ...
                  className={`rounded-lg border py-3 md:py-4 text-xs md:text-sm col-span-2 font-medium transition-colors ${
